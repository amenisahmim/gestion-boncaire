...
public class suppcompte extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					suppcompte frame = new suppcompte();
	...
	public suppcompte() {
		...
		JLabel lblNewLabel_1 = new JLabel("saisir num compte");
		...
		textPane.setBounds(76, 92, 238, 41);
		panel.add(textPane);
		
		JButton btnOk = new JButton("valider");
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String numte=textPane.getText();
				int n= Integer.parseInt(numte);
